...
from .jetbot_controller_env_cfg import JetbotControllerEnvCfg
...
class JetbotControllerEnv(DirectRLEnv):
    cfg: JetbotControllerEnvCfg

    def __init__(self, cfg: JetbotControllerEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _get_rewards(self) -> torch.Tensor:
        forward_reward = self.robot.data.root_com_lin_vel_b[:,0].reshape(-1,1) # forward_reward is the x component of the linear center of mass velocity of the robot in the body frame. (x direction is the forward direction)
