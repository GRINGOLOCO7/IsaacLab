...
@configclass
class BotzoRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # switch robot to botzo
        self.scene.robot = BOTZO_CONFIG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class BotzoRoughEnvCfg_PLAY(BotzoRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
